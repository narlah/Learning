...
public final class HuffmanCompresor extends Compressor {
	private HashMap<Character, String> codes = new HashMap<Character, String>();
	private LinkedHashMap<Character, Integer> treeToFile = new LinkedHashMap<Character, Integer>();

	public HuffmanCompresor(String inFile, String outFile) {
