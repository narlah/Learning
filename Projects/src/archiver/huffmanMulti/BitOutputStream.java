...
public class BitOutputStream extends OutputStream {
	 ...
	 * 
	 * @param outputStream
	 *            The underlying output stream to write bits to.
	 */
	 ...
	 *            The bit to write
	 * @throws IOException
	 *             If an underlying IOException occurs while writing to the
	 *             stream
	 */
	 ...
	 *            The value to write to the output stream
	 * @param numBits
	 *            The number of bits to be written to the output stream
	 * @throws IOException
	 *             If an underlying IOException occurs while writing to the
	 *             stream
	 */
	 ...
	 *            The value to write
	 * @param numFixedBits
	 *            The number of bits used for the M parameter
	 * @throws IOException
	 *             If an underlying IOException occurs while writing to the
	 *             stream
	 */
