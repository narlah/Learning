...
public class MaxNumberOfElementsInARow {
	...
	public static void main(String[] args) { // Testing Method
		...
		Current current = Enclosing.new Current(null, "Поток Двойки, Празен конструктор");
		current.findCurrent();
		...
		// massTestMatrix[6] = 12;
		// massTestMatrix[7] = 12;
		Current massTestCurrent = Enclosing.new Current(massTestMatrix, "Масов Тест с 10000 елемента (1-1000)!");
