...
//Реализирайте  структурата  двойно  свързан динамичен списък – списък, 
//чиито  елементи  имат  указател,  както  към  следващия  така  и  към  пред-хождащия го елемент. 
//Реализирайте операциите добавяне, премахване 
//и търсене  на  елемент,  добавяне  на  елемент  на  определено  място
//(индекс),  извличане  на елемент  по  индекс и  метод,  който  връща масив 
...
public class DoubleLinkedList {
	...
	public void addElement(int inData) { //добавяне
		if (this.Last != null) {
	...
	private void addElementFirst(int inData) { //добавяне отпред
		if (this.First != null) {
	...
	public void deleteElement(int index) { //премахване
	...
	public int findIndexData(int inData) { //търсене  на  елемент
	...
	public void addElementAt(int index, int inData) {//добавяне  на  елемент  на  определено  място (индекс)
	...
	public int getElementAt(int index) { //извличане  на елемент  по  индекс
		if (index > counter || index <= 0) {
			System.out.println("Index out of bounds!");
			return -1;
		} else if (index == 1) {
	...
	public int[] toArray() { //който  връща масив с елементите на списъка.
